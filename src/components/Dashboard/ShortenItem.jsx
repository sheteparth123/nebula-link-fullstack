...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    const fetchMyShortUrl = async () => {
        setLoader(true);
        try {
             const startDate = `${range.startDate}:00`;
             const endDate = `${range.endDate}:59`;
    ...
    }, [selectedUrl, range.startDate, range.endDate]);
  ...
  return (
    ...
    <React.Fragment>
        <div className={`${
          ...
          } flex-col max-h-96 sm:mt-0 mt-5 min-h-96 relative border-t-2 w-[100%] overflow-hidden`}>
